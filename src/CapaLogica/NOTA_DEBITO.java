...
public class NOTA_DEBITO {
    ...
    public String GeneraXML(String idventa,String id_botica) {
        ...
        try {
            ...
            procedure = conex.prepareCall("{ call XML_DE_CABECERA (?,?) }");
            ...
            /* DETALLE VENTA */
            /*****************/
            procedure2 = conex.prepareCall("{ call XML_DE_DETALLE (?,?) }");
        ...
        try {
            ...
            while (rs.next()) {
                listaVtasCabecera.add(
                        new CABECERA(rs.getString("ID_BOTICA"),
                                    ...
                                    rs.getString("ID_VENTA_REF"),
                                    rs.getDate("FECHA_VENTA_REF"),
                                    rs.getString("ID_TIPO_DOCUMENTO_SUNAT_REF"),
                                    rs.getString("SER_NUM_REF"),
                                    rs.getString("ID_CLIENTE_REF"),
            ...
            procedure1 = conex.prepareCall("SELECT * FROM XML_DE WHERE GRUPO=10 AND NE=1 ORDER BY POSICION");
            rs1 = procedure1.executeQuery();
                ...
                if (listaXML.get(i).getVISUALIZA().toString().equals("1"))
                {
                    ...
                    if (!validadorCampo.equals(""))
                    {
                        ...
                        if (listaXML.get(i).getCAMPO().toString().equals("SER_NUM")){
                            RecuperaCampoCabecera = String.valueOf(listaVtasCabecera.get(0).getSerie());
                        }
                        ...
                        if (listaXML.get(i).getCAMPO().toString().equals( "SER_NUM_REF")){
                            RecuperaCampoCabecera = String.valueOf(listaVtasCabecera.get(0).getSerie_ref());
                        }
                        if (listaXML.get(i).getCAMPO().toString().equals("OBSERVACIONES")){
                            RecuperaCampoCabecera = String.valueOf(listaVtasCabecera.get(0).getObservaciones());
                        }
                        if (listaXML.get(i).getCAMPO().toString().equals("ID_TIPO_DOCUMENTO_SUNAT_REF")){
                            RecuperaCampoCabecera = String.valueOf(listaVtasCabecera.get(0).getID_TIPO_DOCUMENTO_SUNAT_REF());
                        }
                       ...
                       //String CampoCabecera = objproducto.RetornaDatoCabeceraND(listaXML.get(i).getCAMPO().toString(),IDVTA,IDBOTI,TOTALTEXTO);
            ...
            procedure3 = conex.prepareCall("SELECT * FROM XML_DE WHERE GRUPO=70 ORDER BY POSICION");
            rs3 = procedure3.executeQuery();
            ...
            /*String VER_C6000 = objproducto.RetornaDatoND("VER_C6000",IDVTA,IDBOTI,"2");
            while (rs3.next()) {
                    ...
                    if (listaXMLDetalle.get(i).getVISUALIZA().toString().equals("1"))
                    {
                        ...
                        if (!validadorCampo1.equals(""))
                        {
                            if (listaXMLDetalle.get(i).getCAMPO().toString().equals("POSICION")){
                                CampoDetalle = String.valueOf(listaVtasDetalle.get(0).getPOSICION());
                            }
                            if (listaXMLDetalle.get(i).getCAMPO().toString().equals("FRAC_NUM")){
                                CampoDetalle = String.valueOf(listaVtasDetalle.get(0).getFRAC_NUM());
                            }
                            if (listaXMLDetalle.get(i).getCAMPO().toString().equals("LineExtionsionAmount")){
                                CampoDetalle = String.valueOf(listaVtasDetalle.get(0).getLineExtionsionAmount());
                            }
                            if (listaXMLDetalle.get(i).getCAMPO().toString().equals("PRECIO_UNITARIO")){
                                CampoDetalle = String.valueOf(listaVtasDetalle.get(0).getPRECIO_UNITARIO());
                            }
                            if (listaXMLDetalle.get(i).getCAMPO().toString().equals("OP_DESCUENTO")){
                                CampoDetalle = String.valueOf(listaVtasDetalle.get(0).getOP_DESCUENTO());
                            }
                            if (listaXMLDetalle.get(i).getCAMPO().toString().equals("IGV")){
                                CampoDetalle = String.valueOf(listaVtasDetalle.get(0).getIGV());
                            }
                            if (listaXMLDetalle.get(i).getCAMPO().toString().equals("OP_GRAVADA")){
                                CampoDetalle = String.valueOf(listaVtasDetalle.get(0).getOP_GRAVADA());
                            }
                            if (listaXMLDetalle.get(i).getCAMPO().toString().equals("PORCENTAJE_IGV")){
                                CampoDetalle = String.valueOf(listaVtasDetalle.get(0).getPORCENTAJE_IGV());
                            }
                            if (listaXMLDetalle.get(i).getCAMPO().toString().equals("TaxExemptionReasonCode")){
                                CampoDetalle = String.valueOf(listaVtasDetalle.get(0).getTaxExemptionReasonCode());
                            }
                            if (listaXMLDetalle.get(i).getCAMPO().toString().equals("PRODUCTO")){
                                CampoDetalle = String.valueOf(listaVtasDetalle.get(0).getPRODUCTO());
                            }
                            if (listaXMLDetalle.get(i).getCAMPO().toString().equals("Id_Producto")){
                                CampoDetalle = String.valueOf(listaVtasDetalle.get(0).getID_PRODUCTO());
                            }
                            if (listaXMLDetalle.get(i).getCAMPO().toString().equals( "TOTAL_UNITARIO_SINIGV")){
                                CampoDetalle = String.valueOf(listaVtasDetalle.get(0).getTOTAL_UNITARIO_SINIGV());
                            }
                            
                            //String CampoDetalle = objproducto.RetornaDatoDetalleND(listaXMLDetalle.get(i).getCAMPO().toString(),IDVTA,IDBOTI);
