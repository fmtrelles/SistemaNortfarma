...
public class BOLETA {
    ...
    public String GeneraXML(String idventa,String id_botica) {
        ...
        //Connection conex = new ConexionPool().getConnection();
        ...
        try {
            ...
            procedure = conex.prepareCall("{ call XML_BE_CABECERA (?,?) }");
            ...
            /* DETALLE VENTA */
            /*****************/
            procedure2 = conex.prepareCall("{ call XML_BE_DETALLE (?,?) }");
        ...
        try {
            ...
            while (rs1.next()) {
                ...
                //for (int i = 0; i < RecuperaXMLBECABECERA.size(); i++)
               //{
...
/*
            ...
            while (rs3.next()) {
               ...
               //for (int n = 0; n < listaVtasDetalle.size(); n++)
               //{
    ...
    /*public List<CABECERA> GeneraXML_LISTA(String idventa)
    {
        String Cadena = "";
        listaProductosXML.clear();
        //String idventa = listaVta.get(0).getId_Venta().toString();
        ...
        return listaVtasCabecera;
        

    }*/


    //public void ver(List<CABECERA> listaXML, List<CABECERA> listaCABECERA,String valor, String campo){
        
        /*listaProductos = objproducto.ListarDatos(listaXML,valor);
        String IDVTA = listaCABECERA.get(0).getId_Venta();
        String Campo = objproducto.RetornaDato(campo,IDVTA);
        
        
        for (int i = 0; i < listaProductos.size(); i++)
        {
            String visualiza = listaProductos.get(i).getVISUALIZA();
            listaProductos.get(i).getVISUALIZA().replaceFirst(Campo,visualiza);

            listadeDatos[0] = listaProductos.get(i).getGRUPO();
            listadeDatos[1] = listaProductos.get(i).getPOSICION();
            listadeDatos[2] = listaProductos.get(i).getTABOPEN();
            listadeDatos[3] = listaProductos.get(i).getCAMPO();
            listadeDatos[4] = listaProductos.get(i).getDEFECTO();
            listadeDatos[5] = listaProductos.get(i).getDATO();
            listadeDatos[6] = listaProductos.get(i).getCIERRE();
            listadeDatos[7] = listaProductos.get(i).getTABCLOSE();
            listadeDatos[8] = Campo;
            listaProductosXML.add(listadeDatos);
        }
