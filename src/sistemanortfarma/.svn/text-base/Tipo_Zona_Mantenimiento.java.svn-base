...
public class Tipo_Zona_Mantenimiento extends javax.swing.JFrame {
   ...
   TableColumn  columnaTabla = null;
    ...
    public Tipo_Zona_Mantenimiento() {
    ...
    private void initComponents() {
        ...
        jTable1 =  new javax.swing.JTable(){
            ...
            org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(sistemanortfarma.SistemaNortfarmaApp.class).getContext().getResourceMap(Tipo_Zona_Mantenimiento.class);
            ...
            jButton1.setBounds(20, 50, 80, 23);
            ...
            jButton2.setBounds(390, 30, 30, 30);
            jLayeredPane1.add(jButton2, javax.swing.JLayeredPane.DEFAULT_LAYER);

            getContentPane().add(jLayeredPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(22, 11, 440, 100));
            ...
            getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(92, 131, 280, 340));

            jSeparator2.setName("jSeparator2"); // NOI18N
            getContentPane().add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(32, 489, 390, -1));

            tmpLbl.setText(resourceMap.getString("tmpLbl.text")); // NOI18N
            tmpLbl.setName("tmpLbl"); // NOI18N
            getContentPane().add(tmpLbl, new org.netbeans.lib.awtextra.AbsoluteConstraints(422, 191, -1, -1));
