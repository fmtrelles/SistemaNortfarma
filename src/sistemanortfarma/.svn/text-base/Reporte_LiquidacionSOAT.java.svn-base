 ...
 */
public class Reporte_LiquidacionSOAT extends javax.swing.JInternalFrame implements Runnable {
    ...
    public Reporte_LiquidacionSOAT(String idboti, OpcionesReportes objeto) {
        initComponents();
        con = objeto.getCon();
        idbotica = idboti;
        cargarTipoDocumento();
    ...
    public void run() {
        ...
        try {
            ...
            //report_file = this.getClass().getResource("/Reportes/VentasxFecha.jasper");LiquidacionVentasxFechaSOAT.jrxml
            report_file = this.getClass().getResource("/Reportes/LiquidacionVentasxFechaSOAT.jasper");
            ...
            view.setTitle("REPORTE DE LIQUIDACION DE VENTAS SOAT POR FECHA");
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(sistemanortfarma.SistemaNortfarmaApp.class).getContext().getResourceMap(Reporte_LiquidacionSOAT.class);
