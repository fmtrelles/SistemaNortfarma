 ...
 */
public class ReporteNotasCredito extends javax.swing.JInternalFrame {
    ...
    public ReporteNotasCredito(String idboti, AplicacionVentas obj) {
        initComponents();
        objventas = obj;
        AparienciaTabla();
        idbotica = idboti;
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(sistemanortfarma.SistemaNortfarmaApp.class).getContext().getResourceMap(ReporteNotasCredito.class);
