 ...
 */
public class VentasxBotica extends javax.swing.JInternalFrame implements Runnable {
    ...
    public VentasxBotica(OpcionesReportes objeto) {
        initComponents();
        obreporte = objeto;
    ...
    public void run() {
        try {
            ...
            archivo = this.getClass().getResource("/Reportes/REPORTE_VENTAS_ANALISIS.jasper");
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(sistemanortfarma.SistemaNortfarmaApp.class).getContext().getResourceMap(VentasxBotica.class);
