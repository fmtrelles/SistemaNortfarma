...
public class LaboratoriosTotal extends javax.swing.JDialog {
    ...
    public static void setDescLab(String DescLab) {
        LaboratoriosTotal.DescLab = DescLab;
    }
    ...
    public static void setIdLab(String IdLab) {
        LaboratoriosTotal.IdLab = IdLab;
    }

    /** Creates new form LabInicio */
    public LaboratoriosTotal() {
        initComponents();
    }

    public LaboratoriosTotal(VentasxLaboratorio obj, java.awt.Frame ventana) {
        super(ventana, true);
        initComponents();
    ...
    public LaboratoriosTotal(ProductosPorLaboratorioStock obj, java.awt.Frame ventana) { //aqui
        super(ventana, true);
        initComponents();
        model = (DefaultTableModel) jTable1.getModel();
        colModel = this.jTable1.getColumnModel();
    ...
    public LaboratoriosTotal(ProductosLaboratorio obj, java.awt.Frame ventana) {
        super(ventana, true);
        initComponents();
        model = (DefaultTableModel) jTable1.getModel();
        colModel = this.jTable1.getColumnModel();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(sistemanortfarma.SistemaNortfarmaApp.class).getContext().getResourceMap(LaboratoriosTotal.class);
