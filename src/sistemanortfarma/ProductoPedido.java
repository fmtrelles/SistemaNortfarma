...
public class ProductoPedido extends JDialog {
     ...
     * @param owner
     */
    public ProductoPedido(ProductosPrecios precios,int opc) {
        super();        
    ...
    private void initialize() {
        ...
        try {
            ...
            Logger.getLogger(ProductoPedido.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    private void Cantidad() {
        if (TxtCantidad.getText().trim().compareTo("") != 0) { 
            ...
            try {
                ...
                int EsBolsa = objproducto.Recupera_EsBolsa(_ProductoCod);
                ...
                if (cantidad.compareTo("0") != 0) {
                    ...
                    if (posi == 0 ){
                        ...
                        if (cuentaParrtes >1){                                  //fracciones
                            ...
                            if (EsBolsa ==1){
                               JOptionPane.showMessageDialog(this, "Este Producto solo se puede vender en Fraccion ", "Error", JOptionPane.ERROR_MESSAGE);
