 ...
 */
public class Reporte_NotaCreditoInv extends javax.swing.JInternalFrame implements Runnable {

    private String Idbotica;
    ReportesInventarios obreporte;
    Thread showThread;
    ...
    public Reporte_NotaCreditoInv(String idbotica, ReportesInventarios objeto) {
        initComponents();
        Idbotica = idbotica;
        obreporte = objeto;
        OcultaLabel(false);
    ...
    //Reporte_NotaCreditoInv(String tempidbotica, ReportesInventarios aThis) {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(sistemanortfarma.SistemaNortfarmaApp.class).getContext().getResourceMap(Reporte_NotaCreditoInv.class);
    ...
    public void run() {
        ...
        try {
            ...
            report_file = this.getClass().getResource("/Reportes/REPORTE_NC_VENTAS_INV.jasper");
            ...
            view.setTitle("REPORTE NOTA DE CREDITO VENTAS ");
