...
/*
 * VentasxVendedor.java
 *
 * Created on 26/05/2011, 12:31:26 PM
 */
 ...
 */
public class VentasxVendedor extends javax.swing.JInternalFrame implements Runnable {
    ...
    public VentasxVendedor(String idboti, OpcionesReportes objeto) throws SQLException {
        initComponents();
        con = objeto.getCon();
    ...
    public void run() {
        ...
        try {
            ...
            parameters.put("TIPVENTA", listTipoDocumento.get(documento.getSelectedIndex()).getId_Tipo_Venta());
            parameters.put("Ninicio", rInicio.getItemAt(rInicio.getSelectedIndex()).toString());
            parameters.put("Nfin", Rfinal.getItemAt(Rfinal.getSelectedIndex()).toString());
            parameters.put("REPORT_CONNECTION", con);

            report_file = this.getClass().getResource("/Reportes/VentasxVendedor.jasper");
            ...
            //   report_file = System.getProperty("user.dir")+"\\src\\Reportes\\VentasxVendedor.jasper";
            ...
            view.setTitle("REPORTE DE VENTAS POR VENDEDOR ");
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(sistemanortfarma.SistemaNortfarmaApp.class).getContext().getResourceMap(VentasxVendedor.class);
        ...
        desde.setPreferredSize(new java.awt.Dimension(120, 21));
        ...
        hasta.setPreferredSize(new java.awt.Dimension(120, 21));

        jLabel5.setText(resourceMap.getString("jLabel5.text")); // NOI18N
        jLabel5.setName("jLabel5"); // NOI18N

        documento.setFont(resourceMap.getFont("documento.font")); // NOI18N
        documento.setModel(new javax.swing.DefaultComboBoxModel(ArrayBoticas));
        documento.setName("documento"); // NOI18N

        rInicio.setFont(resourceMap.getFont("rInicio.font")); // NOI18N
        rInicio.setModel(new javax.swing.DefaultComboBoxModel(ArrayBoticas));
        rInicio.setName("rInicio"); // NOI18N

        Rfinal.setFont(resourceMap.getFont("rInicio.font")); // NOI18N
        Rfinal.setModel(new javax.swing.DefaultComboBoxModel(ArrayBoticas));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(documento, javax.swing.GroupLayout.PREFERRED_SIZE, 186, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(boticas, javax.swing.GroupLayout.PREFERRED_SIZE, 150, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addComponent(desde, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 131, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(Rfinal, javax.swing.GroupLayout.Alignment.LEADING, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(rInicio, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 389, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap())
        );
