...
public class IngresoAbonoCaja extends javax.swing.JFrame {
    ...
    public IngresoAbonoCaja(java.awt.Frame parent, Reporte_Caja_Detallado obj, Cajas objcaja, Object caj) {
        ...
        podecimalPantalla = objet.getCantidadDecimalesPantalla();
        micaja = objcaja;
        cajero = caj;
    ...
    private void MuestraMonto() {
        ...
        txtMontoSis.setText(bd.setScale(podecimalPantalla, BigDecimal.ROUND_HALF_UP).toPlainString());
    }
        ...
        try {
            ...
            if (fila >= 0) {
                ...
                if (TipoMoneda <= 2) {
                    ...
                    if (tabla == 0) {
                        modelo.setValueAt(bd.setScale(podecimalPantalla, BigDecimal.ROUND_HALF_UP).toPlainString(), fila, 5);
                    } else {
                        modelo_1.setValueAt(bd.setScale(podecimalPantalla, BigDecimal.ROUND_HALF_UP).toPlainString(), fila, 5);
                    }
    ...
    private void CalculaTotal() {
        ...
        bd = bd.setScale(podecimal, BigDecimal.ROUND_HALF_UP);
        txtIngresado.setText(bd.setScale(podecimalPantalla, BigDecimal.ROUND_HALF_UP).toPlainString());
        ...
        txtDiferencia.setText(bd1.setScale(podecimalPantalla, BigDecimal.ROUND_HALF_UP).toPlainString());
