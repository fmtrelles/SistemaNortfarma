 ...
 */
public class ConsultarEnvioEfecOfi extends javax.swing.JInternalFrame implements KeyListener {
    ...
    public ConsultarEnvioEfecOfi(AplicacionVentas obj) {
        initComponents();
        if (con == null) {
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(sistemanortfarma.SistemaNortfarmaApp.class).getContext().getResourceMap(ConsultarEnvioEfecOfi.class);
