 ...
 */
public class VerificaAnulaciones extends javax.swing.JDialog {

    private String interno = null;
    private String monto = null;
    LogicaMovimientos log = new LogicaMovimientos();

   public VerificaAnulaciones(Frame obj ) {
        super(obj, true);
        initComponents();
        this.setLocationRelativeTo(null);

      /*  Movimientos movi = log.Devuelve_SerienumeroNC();
        if (movi != null) {
...
*/
    ...
    private void RecuperaData() {
        if (this.jTextField3.getText().trim().length() > 0 && this.jTextField4.getText().trim().length() > 0) {
            interno = this.jTextField3.getText().trim();
            monto = this.jTextField4.getText().trim();
            this.hide();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(sistemanortfarma.SistemaNortfarmaApp.class).getContext().getResourceMap(VerificaAnulaciones.class);
