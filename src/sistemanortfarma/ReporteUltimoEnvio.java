 ...
 */
public class ReporteUltimoEnvio extends javax.swing.JInternalFrame implements Runnable {
    ...
    public ReporteUltimoEnvio(ReportesInventarios obj, String idboti) {
        initComponents();
        objreporte = obj;
        idbotica = idboti;
        con = obj.getCon();        
    ...
    public void run() {
        ...
        try {
            ...
            archivo = this.getClass().getResource("/Reportes/Reporte_UltimoEnvio.jasper");
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(sistemanortfarma.SistemaNortfarmaApp.class).getContext().getResourceMap(ReporteUltimoEnvio.class);
