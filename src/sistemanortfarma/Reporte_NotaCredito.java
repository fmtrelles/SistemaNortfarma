 ...
 */
public class Reporte_NotaCredito extends javax.swing.JInternalFrame implements Runnable {
    ...
    public Reporte_NotaCredito(String idbotica, OpcionesReportes objeto) {
        initComponents();
        Idbotica = idbotica;
        obreporte = objeto;
        OcultaLabel(false);
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(sistemanortfarma.SistemaNortfarmaApp.class).getContext().getResourceMap(Reporte_NotaCredito.class);
    ...
    public void run() {
        ...
        try {
            ...
            report_file = this.getClass().getResource("/Reportes/REPORTE_NC_VENTAS.jasper");
