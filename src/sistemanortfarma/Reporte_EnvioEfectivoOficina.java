 ...
 */
public class Reporte_EnvioEfectivoOficina extends javax.swing.JInternalFrame implements Runnable {
    ...
    List<Personal> Lista_Gerentes = new ArrayList<Personal>();
    ...
    public Reporte_EnvioEfectivoOficina(AplicacionVentas objventa) {
...
//            int supervisor = Lista_Supervisores.get(this.jComboBox5.getSelectedIndex()).getId_PersonalSuper();
    ...
    private void muestraNumero(){
        ...
        String numerocorrelativo = onjproforma.RecuperaNumero(idbotica);
        jTextField4.setText(numerocorrelativo);
    }
    ...
    private void CargarGerentes(){
        Lista_Gerentes = logperso.Lista_Gerentes();

            for (int i = 0; i < Lista_Gerentes.size(); i++) {
                jComboBox5.addItem(Lista_Gerentes.get(i).getApellidoGerencia());
            }
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(sistemanortfarma.SistemaNortfarmaApp.class).getContext().getResourceMap(Reporte_EnvioEfectivoOficina.class);
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(txtIngresado, javax.swing.GroupLayout.PREFERRED_SIZE, 104, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(120, 120, 120))))
        );
    ...
    private void buttonSeven3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSeven3ActionPerformed
        ...
        if (Rendicion.equals("") || Rendicion.length()<=0 || Rendicion.trim().equals(null)|| Rendicion.trim()==null){
           JOptionPane.showMessageDialog(this, "No ha Ingresado Nº de Entrega de Efectivo","NORTFARMA",JOptionPane.ERROR_MESSAGE);
           this.jTextField4.requestFocus();
        }else{
            if (msistema > 0){
                Guardar_Abono();
            ...
            {
                JOptionPane.showMessageDialog(this, "Debe Ingresar Monto a Abonar","NORTFARMA",JOptionPane.ERROR_MESSAGE);
                this.txtIngresado.setText("0.00");
                this.txtIngresado.requestFocus();
            }
        }
        }catch(Exception ex){
    ...
    private void Guardar_Abono() {
        ...
        try {
            ...
            List<Abono_Caja> listaTotalDatosGenerales = new ArrayList<Abono_Caja>();
            Abono_Caja abonoCaja;
            Abono_Caja abonoCajaDatosGenerales;
            ...
            abonoCajaDatosGenerales = new Abono_Caja();
            ...
            abonoCajaDatosGenerales.setBotica(botica);
            abonoCajaDatosGenerales.setPersona(persona);
            abonoCajaDatosGenerales.setCaja(caja);
            abonoCajaDatosGenerales.setFECHA(FechaVtaS);
            abonoCajaDatosGenerales.setTurno(turno);
            listaTotalDatosGenerales.add(abonoCajaDatosGenerales);
            ...
            if (!txtIngresado.getText().equals("") || !txtIngresado.getText().equals("0.0") || !txtIngresado.getText().equals("0.00")) {
               
                boolean Estado = true;               
                if (Estado) {
                    fechaInicio = this.jXDatePicker1.getDate();
                    String Nren = this.jTextField4.getText();
                    int idgerencia = Lista_Gerentes.get(this.jComboBox5.getSelectedIndex()).getId_PersonalGerencia();
                    //int supervisor = 1;

                    int resul = logAbono.Guardar_EnvioEfecOficina(listaTotalDatosGenerales,listaTotal,Nren,idgerencia,idsesion);

                    if (resul == 1) {
                        JOptionPane.showMessageDialog(null, " SU ABONO A OFICINA SE HA REGISTRADO CORRECTAMENTE ", "Ingresado", JOptionPane.INFORMATION_MESSAGE);
    ...
    public void GeneraReporteEfectivo2() {
        ...
        if (Verifica_Datos()) {
            ...
            try {
                ...
                parameters.put("TURNO", turno);
                parameters.put("NUMERO", jTextField4.getText());
                parameters.put("REPORT_CONNECTION", con);
