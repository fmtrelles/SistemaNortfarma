 ...
 */
public class AgregaProductosCarDes extends JDialog {
    ...
    public AgregaProductosCarDes(Frame obj, String idboti, String almacen, int fil,String tipo) {
        super(obj, true);
        initComponents();
        idbotica = idboti;
        alma = almacen;
    ...
    public static void setDescto(double descto) {
        AgregaProductosCarDes.descto = descto;
    }
    ...
    public static void setUnidad(int unidad) {
        AgregaProductosCarDes.unidad = unidad;
    }
    ...
    public static void setFraccion(int fraccion) {
        AgregaProductosCarDes.fraccion = fraccion;
    }
    ...
    public static void setIdproducto(String idproducto) {
        AgregaProductosCarDes.idproducto = idproducto;
    }
    ...
    public static void setRealLab(String realLab) {
        AgregaProductosCarDes.realLab = realLab;
    }
    ...
    public static void setReal(String real) {
        AgregaProductosCarDes.real = real;
    }
    ...
    public static void setRealDes(String realDes) {
        AgregaProductosCarDes.realDes = realDes;
    }
    ...
    public static void setCantidad(String cantidad) {
        AgregaProductosCarDes.cantidad = cantidad;
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(sistemanortfarma.SistemaNortfarmaApp.class).getContext().getResourceMap(AgregaProductosCarDes.class);
    ...
    private void jTextField1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextField1KeyPressed
        ...
        if (evt.getKeyCode() == 10) {
            try {
                ...
                Logger.getLogger(AgregaProductosCarDes.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
