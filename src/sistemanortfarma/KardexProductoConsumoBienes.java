 ...
 */
public class KardexProductoConsumoBienes extends javax.swing.JInternalFrame implements Runnable {
    ...
    public KardexProductoConsumoBienes(String idboti, ReportesInventarios obj, String usuario) {
        initComponents();
        objreporte = obj;
        user = usuario;
        con = obj.getCon();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(sistemanortfarma.SistemaNortfarmaApp.class).getContext().getResourceMap(KardexProductoConsumoBienes.class);
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Codigo", "Descripcion", "Laboratorio", "S-Most-Und", "S-Most-Frac", "S-Alm-Und", "S-Alm-Frac", "Tras.Empaque", "Tras.Fraccion"
            }
        ) {
        ...
        tipoAlmacen.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Trastienda" }));
    ...
    private void BusquedaProducto() {
        ...
        listproducto = objProducto.ListarProductosCarDes1(buscador.getText(), idbotica, opcion,"Trastienda",2);
