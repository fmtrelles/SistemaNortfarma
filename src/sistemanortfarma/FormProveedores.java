...
public class FormProveedores extends javax.swing.JDialog {
    ...
    public FormProveedores(Frame parent) {
        super(parent, true);
        ;
        initComponents();
    ...
    public static void setNombre_Proveedor(String Nombre_Proveedor) {
        FormProveedores.Nombre_Proveedor = Nombre_Proveedor;
    }
    ...
    public static void setIdproveedor(String idproveedor) {
        FormProveedores.idproveedor = idproveedor;
    }

    private void Lista_Proveedores(String texto) {
        texto = texto + '%';
        int marca = this.jComboBox1.getSelectedIndex();
        List<Proveedor> lista = logprovee.Find_Provedores(marca, texto);

        for (int i = 0; i < lista.size(); i++) {

            datosDetalle[0] = lista.get(i).getId_Proveedor();
            datosDetalle[1] = lista.get(i).getDescripcion();
    ...
    private void RecuperaProveedor() {
        ...
        try {
            ...
            if (fila >= 0) {
                ...
                idproveedor = String.valueOf(this.jTable1.getValueAt(fila, 0));
                Nombre_Proveedor = this.jTable1.getValueAt(fila, 1).toString();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(sistemanortfarma.SistemaNortfarmaApp.class).getContext().getResourceMap(FormProveedores.class);
